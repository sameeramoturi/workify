...
SECRET_KEY = os.environ.get('SECRET_KEY', 'workify-super-secret-development-key-12345')
...
# Database Configuration (PostgreSQL with fallback to SQLite for local standalone run)
...
if USE_S3:
    ...
    # Default to public storage for media files
